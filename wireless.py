...
def on_Wireless_button_click():
    print("Wireless button clicked")
...
small_heading_label = tk.Label(root, text="Wireless Communication", font=("Helvetica", 21,"bold"), fg="white", bg="#0D0D15")
...
Wireless_button = tk.Button(root, image=button_image_resized, command=on_Wireless_button_click, bg="#0D0D15", bd=0, height=button_height, width=button_width, borderwidth=0, relief="flat",highlightthickness=0)
Wireless_button.pack()
